...
def compare4Hist(A, B, C, D, textA="A", textB="B", textC="C",textD="D",label_name="sample", can_name="can",reg='reg'):
...
#    pad1.SetLogy(ROOT.kTRUE)
    ...
    A.SetMaximum(1.02*max(A.GetMaximum(),B.GetMaximum(),C.GetMaximum()));
    ...
    ratioB.SetMaximum(1.5)
    ratioB.SetMinimum(0.5)
    r = ratioB.Clone()
    fontScale = 2
...
#    ratio_y_max=1.05*r.GetBinContent(r.GetMaximumBin())
    ...
    dummy_ratio.GetYaxis().SetTitle('Ratio y/2018')
...
variables=["lep1Pt"]#,"lep1Eta","lep1Phi","lep2Pt","lep2Eta","lep2Phi","llM","llPt","llDr","llDphi","jet1Pt","jet1Eta","jet1Phi","njet","nbjet","Met","MetPhi","nVtx","llMZw", "topMass","topL1Dphi","topL1Dr","topL1DptOsumPt","topPt", "BDT","muTkIso","leadElePt","leadEleEta","leadElePhi","leadMuPt",  "leadMuEta", "leadMuPhi","llMZwPt0to100","llMZwPt100to200","llMZwPt200to350","llMZwPt350toInf"]
#variables=["lep1Pt"]
...
for numreg, namereg in enumerate(regions):
    for numvar, namevar in enumerate(variables):
        compare4Hist(Hists[0][0][2][numreg][numvar],Hists[1][0][2][numreg][numvar],Hists[2][0][2][numreg][numvar],Hists[3][0][2][numreg][numvar], '2016preVFP', '2016postVFP', '2017','2018', namevar, 'DATA',namereg)
        compare4Hist(Hists[0][3][2][numreg][numvar],Hists[1][3][2][numreg][numvar],Hists[2][3][2][numreg][numvar],Hists[3][3][2][numreg][numvar], '2016preVFP', '2016postVFP', '2017','2018', namevar, 'DY',namereg)

binsptl = array( 'd',[0,100,200,350,500] )
lepPt_HDataP = ROOT.TH1F( 'DataP', 'DataP',4,binsptl)
lepPt_HDataP.SetBinContent(1, Hists[0][0][2][regions.index('ll-leadMuP')][variables.index('llMZwPt0to100')].GetMean ())
lepPt_HDataP.SetBinContent(2, Hists[0][0][2][regions.index('ll-leadMuP')][variables.index('llMZwPt100to200')].GetMean ())
lepPt_HDataP.SetBinContent(3, Hists[0][0][2][regions.index('ll-leadMuP')][variables.index('llMZwPt200to350')].GetMean ())
lepPt_HDataP.SetBinContent(4, Hists[0][0][2][regions.index('ll-leadMuP')][variables.index('llMZwPt350toInf')].GetMean ())

lepPt_HDataN = ROOT.TH1F( 'DataN', 'DataN',4,binsptl)
lepPt_HDataN.SetBinContent(1, Hists[0][0][2][regions.index('ll-leadMuN')][variables.index('llMZwPt0to100')].GetMean ())
lepPt_HDataN.SetBinContent(2, Hists[0][0][2][regions.index('ll-leadMuN')][variables.index('llMZwPt100to200')].GetMean ())
lepPt_HDataN.SetBinContent(3, Hists[0][0][2][regions.index('ll-leadMuN')][variables.index('llMZwPt200to350')].GetMean ())
lepPt_HDataN.SetBinContent(4, Hists[0][0][2][regions.index('ll-leadMuN')][variables.index('llMZwPt350toInf')].GetMean ())

lepPt_HDYP = ROOT.TH1F( 'DYP', 'DYP',4,binsptl)
lepPt_HDYP.SetBinContent(1, Hists[0][3][2][regions.index('ll-leadMuP')][variables.index('llMZwPt0to100')].GetMean ())
lepPt_HDYP.SetBinContent(2, Hists[0][3][2][regions.index('ll-leadMuP')][variables.index('llMZwPt100to200')].GetMean ())
lepPt_HDYP.SetBinContent(3, Hists[0][3][2][regions.index('ll-leadMuP')][variables.index('llMZwPt200to350')].GetMean ())
lepPt_HDYP.SetBinContent(4, Hists[0][3][2][regions.index('ll-leadMuP')][variables.index('llMZwPt350toInf')].GetMean ())

lepPt_HDYN = ROOT.TH1F( 'DYN', 'DYN',4,binsptl)
lepPt_HDYN.SetBinContent(1, Hists[0][3][2][regions.index('ll-leadMuN')][variables.index('llMZwPt0to100')].GetMean ())
lepPt_HDYN.SetBinContent(2, Hists[0][3][2][regions.index('ll-leadMuN')][variables.index('llMZwPt100to200')].GetMean ())
lepPt_HDYN.SetBinContent(3, Hists[0][3][2][regions.index('ll-leadMuN')][variables.index('llMZwPt200to350')].GetMean ())
lepPt_HDYN.SetBinContent(4, Hists[0][3][2][regions.index('ll-leadMuN')][variables.index('llMZwPt350toInf')].GetMean ())

compare4Hist(lepPt_HDataP,lepPt_HDataN, lepPt_HDYP, lepPt_HDYN, 'Data+', 'Data-', 'DY+','DY-', "LeadingMuonPt", 'DY-DATA',"Mass-Pt")
