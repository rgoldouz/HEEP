...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         Electron_eta_SC[9];   //[nElectron]
   ...
   virtual void     Loop(TString fname, TString data, TString dataset ,string year, TString run, float xs, float lumi, float Nevent, int iseft, int nRuns, MyAnalysis *Evt);
