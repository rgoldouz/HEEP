...
def compare6Hist(A,T,label_name="sample", can_name="can"):
    MarkerStyle=[25,20,21,22,23,4]
    MarkerColor=[2,3,4,1,6,7]
    ...
    pad1.Draw()
    pad1.cd()
    leg = ROOT.TLegend(0.6,0.15,0.9,0.35)
#    pad1.SetLogy()
    A[0].SetTitle("")
    ...
    A[0].GetYaxis().SetRangeUser(0.8*A[0].GetMinimum(),1.05*A[0].GetMaximum())
